...
<div id="wrap">
  ...
  <div id="page_center">
    <div class="brands">
      <a href = "#"><div class="brand1" onmouseover="this.backgroundImage='url(images/brand1_1.png)'">Rosemont</div></a>
   	  <div class="brand2" onmouseover="this.backgroundImage='url(images/brand2_1.png)'">JEstina</div>
	  <div class="brand3" onmouseover="this.backgroundImage='url(images/brand3_1.png)'">Kangol</div>
	  <div class="brand4" onmouseover="this.backgroundImage='url(images/brand4_1.png)'">Stonhenge</div>
	  <div class="brand5" onmouseover="this.backgroundImage='url(images/brand5_1.png)'">Clue</div>
	  <div class="brand6" onmouseover="this.backgroundImage='url(images/brand6_1.png)'">O.S.T</div>
    </div>
